...
export const ru: Record<TranslationKey, string> = {
  ...
  'tour.cascade.body':
    'Деньги расходятся по порядку: долги, размен, конверты, расходы, цели. Если не хватает — уступают цели, потом конверты, потом расходы. Долги и валютные корзины не режутся никогда.',
  ...
  'plan.compressed.note':
    'На всё сразу не хватает — срезано {amount} {ccy}. Первыми уступают цели, потом конверты, потом расходы; долги и корзины остаются целыми.',
