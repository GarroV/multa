...
export const ru: Record<TranslationKey, string> = {
  ...
  'tour.cascade.body':
    'Деньги расходятся по порядку: долги, размен, конверты, категории, цели. Если не хватает — уступают цели, потом конверты, потом категории. Долги и валютные корзины не режутся никогда.',
  'tour.map.title': 'Что будет до выплаты',
  'tour.map.body': 'Ось от выплаты до выплаты: приходы, крупные платежи и сегодняшний день.',
  'tour.categories.title': 'Категории',
